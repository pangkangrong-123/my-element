<!--
 * @Author: your name
 * @Date: 2021-07-15 14:53:37
 * @LastEditTime: 2021-09-01 18:50:39
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \fe-component-lib\src\components\src\xTimeSelect.vue
-->
<template>
  <el-time-select
...
export default {
  ...
  computed: {
    computedConfig() {
      ...
      // 合并配置模式
      const c = this.golbalConfig.timeSelect();
      merge(c, this.config);
      return c;
    },
